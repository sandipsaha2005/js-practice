...
function stringSplitting(string) {
  ...
  for (let index = 0; index < string.copyOfString; index++) {
    let character = copyOfString[index];
    copyOfString[index] = "";
...
function testCode(string, expectedOutput) {
  ...
  const actualOutput = stringSplitting(string, newString);
